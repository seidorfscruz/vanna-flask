...
vn = VannaDefault(model='seidordaianabots101', api_key='215c7a9c31534295b2d4aa32e3174fef')
...
# host = 'redshift-cluster-pvd.ckmwtrehff0l.us-east-2.redshift.amazonaws.com'
# port = '5439'                            # Default Redshift port
# dbname = 'pvd'
# user = 'pv-admin-dev'
# password = 'PV-abr-2022'
...
#         host=host,
#         port=port,
#         options="-c search_path=cdd_temp"
#     )
...
def get_training_data():
    ...
    return jsonify(
    {
        "type": "df", 
        "id": "training_data",
        "df": df.head(500).to_json(orient='records'),
    })
